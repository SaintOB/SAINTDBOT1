...
const NEW_DERIV_CLIENT_ID = '33FCBGiyjs6CSnISZHJT3';
...
export const getNewDerivOAuthUrl = async () => {
    ...
    url.searchParams.set('client_id', NEW_DERIV_CLIENT_ID);
...
export const loginUrl = (_options: TLoginUrl) => {
    ...
    // Touch existing cookies so TypeScript keeps the legacy cookie imports safe while the old Deriv OAuth URL is disabled.
    void server_url;
    void signup_device;
