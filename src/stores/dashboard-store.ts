...
import { TDescriptionItem } from '../constants/pages/bot-builder/quick-strategy/types';
import {
    faq_content,
    guide_content,
    ...
    user_guide_content,
    VIDEOS,
} from '../constants/pages/tutorials/constants';
import { setTourSettings, tour_type, TTourType } from '../constants/pages/tutorials/dbot-tours/utils';
import {
    TFaqContent,
    TGuideContent,
    TQuickStrategyContent,
    TUserGuideContent,
} from '../constants/pages/tutorials/tutorials.types';
